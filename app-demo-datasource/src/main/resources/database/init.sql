...
CREATE USER IF NOT EXISTS  'demo_datasource_reader'@'%' IDENTIFIED WITH mysql_native_password BY 'demo_datasource_reader';
-- 赋权
GRANT ALL PRIVILEGES ON demo_datasource.* TO 'demo_datasource_writer'@'%';
GRANT SELECT ON demo_datasource.* TO 'demo_datasource_reader'@'%';
